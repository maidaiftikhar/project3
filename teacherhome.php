...
<h2>&nbsp Classes</h2>
   <?php
    ...
    if (!(is_null($teacheremail))) {
      $query = "SELECT * FROM classes WHERE teacher_email='$teacheremail'";
    ...
    <th>Add Files from here</th>
      ...
      while($class = mysqli_fetch_assoc($result)){
        ...
        $uniquekey=$class["unique_id"];
      // echo '<a href="teacherhome.php?classname='.$classname.'&key='.$uniquekey.'">'.$classname.'</a>';
?>
      <tr class="tr">
    ...
    <!-- <div class="right">  -->
      ...
      echo '<td><a href="fileupload.php?classname='.$classname.'&key='.$uniquekey.'" >add files</a></td>';
