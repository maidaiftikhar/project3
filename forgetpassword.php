...
.Register-box{
  ...
  border: 2px solid blue; margin-left: 350px;  padding-left: 50px; padding-right: 50px;   background-color:  #51b5a4; height: 300px; width: 440px; border-radius: 10px 10px 10px 10px;">
...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <h4 style="color: white; margin-top: 10px;padding-top: 5px;margin-left: 5px;letter-spacing: 1px; "> Reset Password</h4>
    </div>
...
<br>
     ...
     <div class="container">
      ...
      <div><h4 style="color: white;">Reset Password</h4></div>
    ...
    <div class="form-group">
      ...
      &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
       <input style="width: 250px;height: 30px; border-radius:5px;" type="email"class ="form" name="email">
