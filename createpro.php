...
<br>
	...
	<div style=" border: 2px solid blue; background-color:#51b5a4;height: 350px;width: 500px;margin-left: 31%; padding: 20px;border-radius: 10px;color:white">
...
<a href="studentRegistration.php" style="font-weight: bold; font-size: 1.2em;color: white;">Create a user profile for Student</a><br>
<a href="teacherReg.php" style="font-weight: bold; font-size: 1.2em;color: white;">Create a user profile for Teacher</a>
</div>
</div>
<br>
